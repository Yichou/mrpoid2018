...
#ifndef mrp_userstateopen
#define mrp_userstateopen(l)
#endif



struct mrp_longjmp;  /* defined in ldo.c */
...
#define BASIC_STACK_SIZE        (2*MRP_MINSTACK)
...
typedef struct CallInfo {
  ...
  union {
    struct {  /* for Lua functions */
      ...
      const Instruction **pc;  /* points to `pc' variable in `mr_V_execute' */
...
/* 1 if (Lua) function has an active `mr_V_execute' running it */
...
typedef struct global_State {
  ...
  mrp_CFunction panic;  /* to be called in unprotected errors */
  TObject _registry;
  TObject _defaultmeta;
  struct mrp_State *mainthread;
...
struct mrp_State {
  ...
  GCObject *gclist;
  struct mrp_longjmp *errorJmp;  /* current error recover point */
...
union GCObject {
  ...
  struct Proto p;
  struct UpVal uv;
  struct mrp_State th;  /* thread */
};


/* macros to convert a GCObject into a specific value */
#define gcotots(o)	check_exp((o)->gch.tt == MRP_TSTRING, &((o)->ts))
#define gcotou(o)	check_exp((o)->gch.tt == MRP_TUSERDATA, &((o)->u))
#define gcotocl(o)	check_exp((o)->gch.tt == MRP_TFUNCTION, &((o)->cl))
#define gcotoh(o)	check_exp((o)->gch.tt == MRP_TTABLE, &((o)->h))
#define gcotop(o)	check_exp((o)->gch.tt == MRP_TPROTO, &((o)->p))
#define gcotouv(o)	check_exp((o)->gch.tt == MRP_TUPVAL, &((o)->uv))
#define ngcotouv(o) \
	check_exp((o) == NULL || (o)->gch.tt == MRP_TUPVAL, &((o)->uv))
#define gcototh(o)	check_exp((o)->gch.tt == MRP_TTHREAD, &((o)->th))
